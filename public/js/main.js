...
$(document).ready(function() {
  ...
  $("#dateTime").click(function(){
    ...
    $("#datesTime").append("<label>From:</label><input type='date' class='form-control' name='dateFromOvertime" + value + "' /> <br/>");
    $("#datesTime").append("<input type='time' class='form-control' name='timeFromOvertime" + value + "' /><br/>");
    $("#datesTime").append("<label>To:</label><input type='date' class='form-control' name='dateToOvertime" + value + "' /> <br/>");
    $("#datesTime").append("<input type='time' class='form-control' name='timeToOvertime" + value + "' /><hr/>");
  });
