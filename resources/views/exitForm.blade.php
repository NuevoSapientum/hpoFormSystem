...
@section('content')
  <form>
      ...
      <label>Name:</label>
      <input type="text" class="form-control" placeholder="Please Enter Your Name Here" required autofocus><br/>
